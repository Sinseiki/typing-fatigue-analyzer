...
keys = {
  ...
  '-'  => Key.new('-',  4,  $left_hand.finger(4), [0  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  ...
  'p'  => Key.new('p',  4, $right_hand.finger(2), [4  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '['  => Key.new('[',  4,  $left_hand.finger(3), [3  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  ...
  "'"  => Key.new("'",  4,  $left_hand.finger(2), [2  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  ...
  ','  => Key.new(',',  3, $right_hand.finger(3), [6  + row_offsets[2], row_ycoords[2] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '.'  => Key.new('.',  4, $right_hand.finger(5), [8  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '/'  => Key.new('/',  2,  $left_hand.finger(3), [3  + row_offsets[1], row_ycoords[1] * yaxis_scale_factor], [0.0, 0.0], 0.0),
}
