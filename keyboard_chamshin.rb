...
keys = {
  '1'  => Key.new('1',  1,  $left_hand.finger(5), [0  + row_offsets[0], row_ycoords[0] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '2'  => Key.new('2',  1,  $left_hand.finger(5), [1  + row_offsets[0], row_ycoords[0] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '3'  => Key.new('3',  1,  $left_hand.finger(4), [2  + row_offsets[0], row_ycoords[0] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  ...
  '9'  => Key.new('9',  1, $right_hand.finger(4), [8  + row_offsets[0], row_ycoords[0] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '0'  => Key.new('0',  1, $right_hand.finger(5), [9  + row_offsets[0], row_ycoords[0] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '-'  => Key.new('-',  1, $right_hand.finger(5), [10 + row_offsets[0], row_ycoords[0] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  '='  => Key.new('=',  1, $right_hand.finger(5), [11 + row_offsets[0], row_ycoords[0] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  ...
  'z'  => Key.new('z',  4,  $left_hand.finger(4), [0  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  'x'  => Key.new('x',  4,  $left_hand.finger(3), [1  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
  'c'  => Key.new('c',  4,  $left_hand.finger(2), [2  + row_offsets[3], row_ycoords[3] * yaxis_scale_factor], [0.0, 0.0], 0.0),
